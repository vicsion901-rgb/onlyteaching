  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">💼 NEIS 업무</h1>
          <p className="mt-1 text-sm text-gray-500">NEIS 관련 업무를 관리합니다</p>
        </div>
        <button 
      ...
      <div className="bg-white overflow-hidden shadow rounded-lg">
        <div className="px-4 py-5 sm:p-6">
          <h2 className="text-lg font-medium leading-6 text-gray-900 mb-4">NEIS 업무 관련 무엇이든 물어보세요.</h2>
            ...
            <div className="mb-2">
              ...
              <div className="relative">
                <textarea
                  ...
                  rows={12}
                  placeholder="NEIS 업무 관련 무엇이든 물어보세요."
                  value={prompt}
