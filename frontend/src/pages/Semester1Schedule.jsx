    ...
    <div className="space-y-6">
      ...
      <div className="bg-white overflow-hidden shadow rounded-lg">
        <div className="px-4 py-5 sm:p-6">
          <h2 className="text-lg font-medium leading-6 text-gray-900 mb-4">1학기 업무 일정 관련 무엇이든 물어보세요.</h2>
            ...
            <div className="mb-2">
              ...
              <div className="relative">
                <textarea
                  ...
                  rows={12}
                  placeholder="1학기 업무 일정 관련 무엇이든 물어보세요."
                  value={prompt}
...
export default Semester1Schedule;
