  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">🍁 업무 일정 (2학기)</h1>
          <p className="mt-1 text-sm text-gray-500">2학기 업무 일정을 관리합니다</p>
        </div>
        <button 
      ...
      <div className="bg-white overflow-hidden shadow rounded-lg">
        <div className="px-4 py-5 sm:p-6">
          <h2 className="text-lg font-medium leading-6 text-gray-900 mb-4">2학기 업무 일정 관련 무엇이든 물어보세요.</h2>
            ...
            <div className="mb-2">
              ...
              <div className="relative">
                <textarea
                  ...
                  rows={12}
                  placeholder="2학기 업무 일정 관련 무엇이든 물어보세요."
                  value={prompt}
...
export default Semester2Schedule;
